...
typedef enum                                                                    // 枚举 SPI SCK 引脚 此枚举定义不允许用户修改
{
    ...
    SPI0_SCK_B3         = ((SPI_0 << SPI_INDEX_OFFSET) | (GPIO_AF11 << SPI_PIN_AF_OFFSET) | (B3 )),
    ...
    SPI1_SCK_A20        = ((SPI_1 << SPI_INDEX_OFFSET) | (GPIO_AF3  << SPI_PIN_AF_OFFSET) | (A20)),
    ...
    SPI1_SCK_B23        = ((SPI_1 << SPI_INDEX_OFFSET) | (GPIO_AF3  << SPI_PIN_AF_OFFSET) | (B23)),
}spi_sck_pin_enum;
...
typedef enum                                                                    // 枚举 SPI MOSI 引脚 此枚举定义不允许用户修改
{
    ...
    SPI0_MOSI_B2        = ((SPI_0 << SPI_INDEX_OFFSET) | (GPIO_AF11 << SPI_PIN_AF_OFFSET) | (B2 )),
    ...
    SPI1_MOSI_B22       = ((SPI_1 << SPI_INDEX_OFFSET) | (GPIO_AF3  << SPI_PIN_AF_OFFSET) | (B22)),
}spi_mosi_pin_enum;
...
typedef enum                                                                    // 枚举 SPI MISO 引脚 此枚举定义不允许用户修改
{
    ...
    SPI0_MISO_A7        = ((SPI_0 << SPI_INDEX_OFFSET) | (GPIO_AF11 << SPI_PIN_AF_OFFSET) | (A7 )),
    ...
    SPI1_MISO_B21       = ((SPI_1 << SPI_INDEX_OFFSET) | (GPIO_AF3  << SPI_PIN_AF_OFFSET) | (B21)),
}spi_miso_pin_enum;
...
typedef enum                                                                    // 枚举 SPI CS 引脚 此枚举定义不允许用户修改
{
    ...
    SPI0_CS_A4          = ((SPI_0 << SPI_INDEX_OFFSET) | (GPIO_AF11 << SPI_PIN_AF_OFFSET) | (A4 )),
    SPI0_CS_A8          = ((SPI_0 << SPI_INDEX_OFFSET) | (GPIO_AF3  << SPI_PIN_AF_OFFSET) | (A8 )),
    SPI0_CS_A18         = ((SPI_0 << SPI_INDEX_OFFSET) | (GPIO_AF9  << SPI_PIN_AF_OFFSET) | (A18)),
    ...
    SPI1_CS_A13         = ((SPI_1 << SPI_INDEX_OFFSET) | (GPIO_AF8  << SPI_PIN_AF_OFFSET) | (A13)),
    ...
    SPI1_CS_B13         = ((SPI_1 << SPI_INDEX_OFFSET) | (GPIO_AF7  << SPI_PIN_AF_OFFSET) | (B13)),
