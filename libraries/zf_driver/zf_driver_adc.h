...
typedef enum                                                                    // 枚举 ADC 引脚通道  此枚举定义不允许用户修改
{
    ...
    ADC0_CH8_A12    = ((ADC_0 << ADC_INDEX_OFFSET) | (ADC_CHANNEL_8  << ADC_CHANNEL_OFFSET) | (A12)),
    ADC0_CH9_A13    = ((ADC_0 << ADC_INDEX_OFFSET) | (ADC_CHANNEL_9  << ADC_CHANNEL_OFFSET) | (A13)),
    ADC0_CH12_A14   = ((ADC_0 << ADC_INDEX_OFFSET) | (ADC_CHANNEL_12 << ADC_CHANNEL_OFFSET) | (A14)),
    ...
    ADC1_CH8_B21    = ((ADC_1 << ADC_INDEX_OFFSET) | (ADC_CHANNEL_8  << ADC_CHANNEL_OFFSET) | (B21)),
    ADC1_CH10_B22   = ((ADC_1 << ADC_INDEX_OFFSET) | (ADC_CHANNEL_10 << ADC_CHANNEL_OFFSET) | (B22)),
    ADC1_CH11_B23   = ((ADC_1 << ADC_INDEX_OFFSET) | (ADC_CHANNEL_11 << ADC_CHANNEL_OFFSET) | (B23)),
    ADC1_CH12_A23   = ((ADC_1 << ADC_INDEX_OFFSET) | (ADC_CHANNEL_12 << ADC_CHANNEL_OFFSET) | (A23)),
    ADC1_CH13_B26   = ((ADC_1 << ADC_INDEX_OFFSET) | (ADC_CHANNEL_13 << ADC_CHANNEL_OFFSET) | (B26)),
    ADC1_CH14_B27   = ((ADC_1 << ADC_INDEX_OFFSET) | (ADC_CHANNEL_14 << ADC_CHANNEL_OFFSET) | (B27)),
}adc_pin_enum;
