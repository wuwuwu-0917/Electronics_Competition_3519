...
static void clock_reset (void)
{
    ...
    DL_UART_Main_reset(UART4);
    DL_UART_Main_reset(UART5);
    DL_UART_Main_reset(UART6);
    DL_UART_Main_reset(UART7);
    DL_UART_Main_enablePower(UART0);
    DL_UART_Main_enablePower(UART1);
    DL_UART_Main_enablePower(UART3);
    DL_UART_Main_enablePower(UART4);
    DL_UART_Main_enablePower(UART5);
    DL_UART_Main_enablePower(UART6);
    DL_UART_Main_enablePower(UART7);
